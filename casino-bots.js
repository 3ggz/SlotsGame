...
(() => {
  ...
  const GAME_CONFIG = {
    ...
    diamonddrop:        { name: 'Diamond Drop',         betPct: [0.005, 0.04], rounds: [2, 5],    hitRate: 0.52, payout: [0.2, 170], bigMult: 5,  fav: 1.1, tempo: 0,    replyRate: 0,    idle: 1, perPlayer: 1, max: 4, sessionMin: 6,  sessionMax: 25 },

...
(() => {
  ...
  const GAME_CONFIG = {
    ...
    icecoldbeer:        { name: 'Ice Cold Beer',        betPct: [0.005, 0.04], rounds: [2, 6],    hitRate: 0.40, payout: [1.4, 28],  bigMult: 4,  fav: 0.9, tempo: 0,    replyRate: 0,    idle: 1, perPlayer: 1, max: 4, sessionMin: 6,  sessionMax: 28 },
    ...
    bingo:              { name: 'Bingo',                betPct: [0.01,  0.05], rounds: [25, 60],  hitRate: 0.40, payout: [1, 27],    bigMult: 6,  fav: 1.2, tempo: 0,    replyRate: 0,    idle: 3, perPlayer: 6, max: 30, sessionMin: 8,  sessionMax: 30 },
  };
